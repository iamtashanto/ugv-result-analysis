...
(function (root) {
  ...
  function gradeSheetHtml(model, opts) {
    ...
    <style>
      * { box-sizing: border-box; }
      ...
      <footer><span>Generated by UGV Result Analysis — for personal reference; not an official transcript.</span><span>${esc(now)}</span></footer>
    </body></html>`;
  }
  ...
  function planSheetHtml(model, plan) {
    ...
    const inner = `
      ...
      <footer><span>Generated by UGV Result Analysis — planning aid only; retake rules follow your department.</span><span>${esc(now)}</span></footer>`;
